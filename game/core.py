    ...
    while running:
                ...
                if game_over:
                    ...
                    if event.key == pygame.K_e or event.key == pygame.K_LSHIFT or event.key == pygame.K_RSHIFT:
                        if not transition_active:
                            ...
                            draw_game(old_screen_capture, player.is_white, player, platforms, projectiles, effects, spikes, camera)
        ...
        if not game_over:
            ...
            if transition_active:
                ...
                draw_game(next_state_capture, player.is_white, player, platforms, projectiles, effects, spikes, camera)
                ...
                # Standard Draw
                draw_game(canvas, player.is_white, player, platforms, projectiles, effects, spikes, camera)
